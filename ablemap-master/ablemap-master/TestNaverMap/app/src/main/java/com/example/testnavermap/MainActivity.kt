...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener, OnMapReadyCallback {
    ...
    private fun insertToDB() {
        ...
        spotTable?.insert("UN기념공원", "부산 남구 유엔평화로 93", "unpark",
                "http://naver.me/GaMYZohh",

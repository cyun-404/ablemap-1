...
public class SpotTable extends BaseTable {
  ...
  // 테이블
  public final static String TABLE_NAME = "SpotTable";
  ...
  // 주로 사용할 필드 목록
  private static final String[] COLUMNS = { _ID, NAME, ADDRESS, IMAGE, PICTO_A,PICTO_B,PICTO_C,PICTO_D,PICTO_E,PICTO_F,PICTO_G,PICTO_H,PICTO_I,PICTO_J,PICTO_K};
   ...
   * 입력
   */
  public int insert(String name, String address, String image,
  ...
  private Spot makeRest(Cursor cursor) {
    ...
    return new Spot(id, name, address,image,a,b,c,d,e,f,g,h,i,j,k);
  }
